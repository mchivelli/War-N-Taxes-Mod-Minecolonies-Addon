...
/**
 * Tracks recruitment times for entities to provide accurate grace period
 * detection.
 * This system helps distinguish between newly recruited entities and existing
 * ones.
 */
public class RecruitmentTracker {
    ...
    // Entries older than this threshold are pruned to prevent unbounded growth.
    ...
    /**
     * Remove tracking for an entity (called when entity is removed or no longer
     * relevant)
     */
