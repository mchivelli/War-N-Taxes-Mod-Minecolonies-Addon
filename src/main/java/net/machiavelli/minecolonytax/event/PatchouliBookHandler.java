...
public class PatchouliBookHandler {
    ...
    public static final ResourceLocation BOOK_ID = ResourceLocation.fromNamespaceAndPath(MineColonyTax.MOD_ID, "war_taxes_codex");
    ...
    public static void onPlayerLogin(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        // death and respawn (NeoForge copies this compound during PlayerEvent.Clone).
