...
public class TaxConfig {
        ...
        public static final ModConfigSpec.IntValue MIN_GUARDS_TO_RAID;
        ...
        public static final ModConfigSpec.IntValue WAR_TAX_FREEZE_CYCLES;
        public static final ModConfigSpec.DoubleValue MAX_COMBINED_WAR_PENALTY_PERCENT;
        public static final ModConfigSpec.DoubleValue MIN_TAX_GENERATION_PERCENT;

        // Colony Occupation Configuration
        public static final ModConfigSpec.BooleanValue ENABLE_OCCUPATION_SYSTEM;
        public static final ModConfigSpec.IntValue OCCUPATION_DURATION_DAYS;
        public static final ModConfigSpec.DoubleValue OCCUPATION_TAX_PERCENTAGE;

        // High Stakes War Configuration
        public static final ModConfigSpec.BooleanValue ENABLE_OUTPOST_VULNERABILITY;
        public static final ModConfigSpec.BooleanValue ENABLE_COLONY_WAGER;
        ...
        public static final ModConfigSpec.IntValue LOG_LEVEL;
        ...
        public static final ModConfigSpec.BooleanValue ENABLE_LIST_ABANDONED_FOR_ALL;
        public static final ModConfigSpec.BooleanValue RESET_TIMER_ON_OFFICER_LOGIN;
        ...
        public static final ModConfigSpec.BooleanValue GIVE_PATCHOULI_BOOK_ON_JOIN;
        public static final ModConfigSpec.BooleanValue SHOW_ADMIN_PAGES_IN_BOOK;
        ...
        // Tax Policies
        public static final ModConfigSpec.BooleanValue ENABLE_TAX_POLICIES;
        public static final ModConfigSpec.DoubleValue TAX_POLICY_LOW_REVENUE_MODIFIER;
        public static final ModConfigSpec.DoubleValue TAX_POLICY_LOW_HAPPINESS_MODIFIER;
        public static final ModConfigSpec.DoubleValue TAX_POLICY_HIGH_REVENUE_MODIFIER;
        public static final ModConfigSpec.DoubleValue TAX_POLICY_HIGH_HAPPINESS_MODIFIER;
        public static final ModConfigSpec.DoubleValue TAX_POLICY_WAR_REVENUE_MODIFIER;
        public static final ModConfigSpec.DoubleValue TAX_POLICY_WAR_HAPPINESS_MODIFIER;

        // Tax Reports
        public static final ModConfigSpec.BooleanValue ENABLE_TAX_REPORTS;
        public static final ModConfigSpec.IntValue TAX_REPORT_AUTO_DELETE_HOURS;
        public static final ModConfigSpec.IntValue TAX_REPORT_MAX_HISTORY_DAYS;

        // Leaderboards
        public static final ModConfigSpec.BooleanValue ENABLE_LEADERBOARDS;
        public static final ModConfigSpec.IntValue LEADERBOARD_UPDATE_INTERVAL_MINUTES;
        public static final ModConfigSpec.IntValue LEADERBOARD_TOP_COUNT;

        // ========== TAX EXPANSION: Faction Settings ==========
        public static final ModConfigSpec.BooleanValue ENABLE_FACTION_SYSTEM;
        public static final ModConfigSpec.IntValue MAX_FACTION_MEMBERS;
        public static final ModConfigSpec.IntValue FACTION_CREATION_COST;
        public static final ModConfigSpec.IntValue FACTION_ALLIANCE_LIMIT;

        // Shared Tax Pool
        public static final ModConfigSpec.BooleanValue ENABLE_SHARED_TAX_POOL;
        public static final ModConfigSpec.IntValue DEFAULT_POOL_CONTRIBUTION_PERCENT;
        public static final ModConfigSpec.IntValue MAX_POOL_BALANCE;
        public static final ModConfigSpec.IntValue POOL_HISTORY_RETENTION_DAYS;

        // Trade Routes
        public static final ModConfigSpec.BooleanValue ENABLE_TRADE_ROUTES;
        public static final ModConfigSpec.IntValue TRADE_ROUTE_INCOME_PER_CHUNK;
        public static final ModConfigSpec.IntValue TRADE_ROUTE_MAX_DISTANCE_CHUNKS;
        public static final ModConfigSpec.IntValue TRADE_ROUTE_MAINTENANCE_COST;
        public static final ModConfigSpec.IntValue MAX_TRADE_ROUTES_PER_COLONY;

        // ========== TAX EXPANSION: Espionage Settings ==========
        public static final ModConfigSpec.BooleanValue ENABLE_SPY_SYSTEM;
        public static final ModConfigSpec.IntValue SPY_COOLDOWN_MINUTES;
        public static final ModConfigSpec.DoubleValue SPY_DETECTION_BASE_CHANCE;
        public static final ModConfigSpec.IntValue SPY_MAX_ACTIVE_PER_PLAYER;
        public static final ModConfigSpec.IntValue SPY_SCOUT_MAX_DURATION_HOURS;

        // Spy Action Costs
        public static final ModConfigSpec.IntValue SPY_SCOUT_COST;
        public static final ModConfigSpec.IntValue SPY_SABOTAGE_COST;
        public static final ModConfigSpec.IntValue SPY_BRIBE_GUARDS_COST;
        public static final ModConfigSpec.IntValue SPY_STEAL_SECRETS_COST;

        // Spy Action Effects
        public static final ModConfigSpec.DoubleValue SPY_SABOTAGE_TAX_REDUCTION_PERCENT;
        public static final ModConfigSpec.IntValue SPY_BRIBE_GUARDS_DISABLED_COUNT;
        public static final ModConfigSpec.IntValue SPY_STEAL_SECRETS_DURATION_HOURS;

        // Spy Action Min Field Times
        public static final ModConfigSpec.IntValue SPY_SABOTAGE_MIN_FIELD_MINUTES;

        // Spy Action Detection Chances
        public static final ModConfigSpec.DoubleValue SPY_SCOUT_DETECTION_CHANCE;
        public static final ModConfigSpec.DoubleValue SPY_SABOTAGE_DETECTION_CHANCE;
        public static final ModConfigSpec.DoubleValue SPY_BRIBE_GUARDS_DETECTION_CHANCE;
        public static final ModConfigSpec.DoubleValue SPY_STEAL_SECRETS_DETECTION_CHANCE;

        // Progressive Intel Thresholds
        public static final ModConfigSpec.IntValue INTEL_EARLY_THRESHOLD_MINUTES;
        public static final ModConfigSpec.IntValue INTEL_MID_THRESHOLD_MINUTES;
        public static final ModConfigSpec.IntValue INTEL_LATE_THRESHOLD_MINUTES;

        // Flee Behavior
        public static final ModConfigSpec.DoubleValue FLEE_SPEED_MULTIPLIER;
        public static final ModConfigSpec.IntValue FLEE_ESCAPE_DISTANCE;
        public static final ModConfigSpec.IntValue FLEE_MAX_SECONDS;

        // Spy Travel Phase
        public static final ModConfigSpec.IntValue SPY_TRAVEL_BLOCKS_PER_MINUTE;
        public static final ModConfigSpec.IntValue SPY_TRAVEL_MIN_MINUTES;
        public static final ModConfigSpec.IntValue SPY_TRAVEL_MAX_MINUTES;

        // Spy Map
        public static final ModConfigSpec.BooleanValue SPY_MAP_ENABLED;
        public static final ModConfigSpec.IntValue SPY_MAP_SCALE;

        // ========== TAX EXPANSION: War Chest ==========
        public static final ModConfigSpec.BooleanValue ENABLE_WAR_CHEST;
        public static final ModConfigSpec.DoubleValue WAR_CHEST_MIN_PERCENT_OF_TARGET;
        public static final ModConfigSpec.DoubleValue WAR_CHEST_MIN_PERCENT_OF_OWN_TAX;
        public static final ModConfigSpec.IntValue WAR_CHEST_DRAIN_PER_MINUTE;
        public static final ModConfigSpec.BooleanValue WAR_CHEST_DRAIN_USE_PERCENT;
        public static final ModConfigSpec.DoubleValue WAR_CHEST_DRAIN_PERCENT;
        public static final ModConfigSpec.IntValue WAR_CHEST_MAX_CAPACITY;
        public static final ModConfigSpec.BooleanValue WAR_CHEST_AUTO_SURRENDER_ENABLED;
        public static final ModConfigSpec.DoubleValue WAR_CHEST_AUTO_DEPOSIT_PERCENT;
        public static final ModConfigSpec.DoubleValue WAR_DEFENDER_DRAIN_REDUCTION;

        // Raid War Chest
        public static final ModConfigSpec.BooleanValue RAID_WAR_CHEST_ENABLED;
        public static final ModConfigSpec.DoubleValue RAID_WAR_CHEST_COST_PERCENT;

        // Raid Penalties
        public static final ModConfigSpec.DoubleValue RAID_PENALTY_TAX_REDUCTION_PERCENT;
        public static final ModConfigSpec.IntValue RAID_PENALTY_DURATION_HOURS;
        public static final ModConfigSpec.DoubleValue RAID_REPAIR_COST_PERCENT;

        // ========== TAX EXPANSION: War Exhaustion ==========
        public static final ModConfigSpec.BooleanValue ENABLE_WAR_EXHAUSTION;
        public static final ModConfigSpec.DoubleValue WAR_TAX_REDUCTION_PERCENT;
        public static final ModConfigSpec.IntValue POST_WAR_RECOVERY_HOURS;

        // War Reparations
        public static final ModConfigSpec.BooleanValue ENABLE_WAR_REPARATIONS;
        public static final ModConfigSpec.DoubleValue REPARATIONS_TAX_PENALTY_PERCENT;
        public static final ModConfigSpec.IntValue REPARATIONS_DURATION_HOURS;
        public static final ModConfigSpec.IntValue REPARATIONS_TRIGGER_LOSSES_COUNT;

        // War Weariness Protection
        public static final ModConfigSpec.BooleanValue ENABLE_WAR_WEARINESS;
        public static final ModConfigSpec.IntValue WAR_WEARINESS_THRESHOLD;
        public static final ModConfigSpec.IntValue WAR_WEARINESS_IMMUNITY_HOURS;

        // Vassalization Economy
        public static final ModConfigSpec.BooleanValue VASSALIZATION_REPLACES_REPARATIONS;

        // ========== TAX EXPANSION: Ransom System ==========
        public static final ModConfigSpec.BooleanValue ENABLE_RANSOM_SYSTEM;
        public static final ModConfigSpec.DoubleValue RANSOM_DEFAULT_PERCENT;
        public static final ModConfigSpec.IntValue RANSOM_MIN_AMOUNT;
        public static final ModConfigSpec.IntValue RANSOM_MAX_AMOUNT;
        ...
        public static final ModConfigSpec.DoubleValue INVESTMENT_DIMINISHING_RETURNS_FACTOR;

        // Infrastructure Investment
        public static final ModConfigSpec.IntValue INVESTMENT_INFRASTRUCTURE_COST;
        public static final ModConfigSpec.DoubleValue INVESTMENT_INFRASTRUCTURE_BONUS;
        public static final ModConfigSpec.IntValue INVESTMENT_INFRASTRUCTURE_MAX_STACKS;

        // Guard Training Investment
        public static final ModConfigSpec.IntValue INVESTMENT_GUARD_TRAINING_COST;
        public static final ModConfigSpec.DoubleValue INVESTMENT_GUARD_TRAINING_DAMAGE_BONUS;
        public static final ModConfigSpec.IntValue INVESTMENT_GUARD_TRAINING_DURATION_HOURS;

        // Festival Investment
        public static final ModConfigSpec.IntValue INVESTMENT_FESTIVAL_COST;
        public static final ModConfigSpec.DoubleValue INVESTMENT_FESTIVAL_HAPPINESS_BONUS;
        public static final ModConfigSpec.IntValue INVESTMENT_FESTIVAL_DURATION_HOURS;

        // Research Investment
        public static final ModConfigSpec.IntValue INVESTMENT_RESEARCH_COST;
        public static final ModConfigSpec.DoubleValue INVESTMENT_RESEARCH_SPY_DEFENSE_BONUS;
        public static final ModConfigSpec.IntValue INVESTMENT_RESEARCH_DURATION_DAYS;

        // ==================== RANDOM EVENTS SYSTEM ====================
        public static final ModConfigSpec.BooleanValue ENABLE_RANDOM_EVENTS;
        public static final ModConfigSpec.IntValue RANDOM_EVENT_CHECK_FREQUENCY;
        public static final ModConfigSpec.IntValue RANDOM_EVENT_GLOBAL_COOLDOWN_CYCLES;
        public static final ModConfigSpec.IntValue RANDOM_EVENT_MAX_SIMULTANEOUS;
        public static final ModConfigSpec.DoubleValue RANDOM_EVENT_BASE_CHANCE_MULTIPLIER;
        public static final ModConfigSpec.IntValue RANDOM_EVENT_PROTECT_NEW_COLONIES_HOURS;

        // Individual Event Toggles
        public static final ModConfigSpec.BooleanValue ENABLE_MERCHANT_CARAVAN;
        public static final ModConfigSpec.BooleanValue ENABLE_BOUNTIFUL_HARVEST;
        public static final ModConfigSpec.BooleanValue ENABLE_CULTURAL_FESTIVAL;
        public static final ModConfigSpec.BooleanValue ENABLE_SUCCESSFUL_RECRUITMENT;
        public static final ModConfigSpec.BooleanValue ENABLE_FOOD_SHORTAGE;
        public static final ModConfigSpec.BooleanValue ENABLE_DISEASE_OUTBREAK;
        public static final ModConfigSpec.BooleanValue ENABLE_BANDIT_HARASSMENT;
        public static final ModConfigSpec.BooleanValue ENABLE_CORRUPT_OFFICIAL;
        public static final ModConfigSpec.BooleanValue ENABLE_WANDERING_TRADER_OFFER;
        public static final ModConfigSpec.BooleanValue ENABLE_NEIGHBORING_ALLIANCE;
        public static final ModConfigSpec.BooleanValue ENABLE_WAR_PROFITEERING;
        public static final ModConfigSpec.BooleanValue ENABLE_GUARD_DESERTION;
        public static final ModConfigSpec.BooleanValue ENABLE_LABOR_STRIKE;
        public static final ModConfigSpec.BooleanValue ENABLE_PLAGUE_OUTBREAK;
        public static final ModConfigSpec.BooleanValue ENABLE_ROYAL_FEAST;
        public static final ModConfigSpec.BooleanValue ENABLE_CROP_BLIGHT;
        ...
        static {
                ...
                WAR_CHEST_MIN_PERCENT_OF_OWN_TAX = BUILDER.comment(
                                "Minimum war chest balance also required as percentage of the attacker's OWN tax balance (0.0-1.0). "
                                                +
                                                "The higher of this value and WarChestMinPercentOfTarget is used. "
                                                +
                                                "Prevents wealthy colonies from cheaply bullying poor ones. "
                                                +
                                                "Example: 0.10 = also need 10% of your own tax balance in the chest.")
                                .defineInRange("WarChestMinPercentOfOwnTax", 0.10, 0.0, 2.0);

                WAR_CHEST_DRAIN_PER_MINUTE = BUILDER.comment(
                                "Flat amount drained from war chest per minute during active war. "
                                                + "Full 250min at default (10/min on 25k chest, ~4h to deplete). "
                                                +
                                                "Only used when WarChestDrainUsePercent is false.")
                                .defineInRange("WarChestDrainPerMinute", 10, 0, 10000);

                WAR_CHEST_DRAIN_USE_PERCENT = BUILDER.comment(
                                "If true, war chest drains by a percentage of max capacity per minute (proportional burn). "
                                                +
                                                "If false, uses the flat WarChestDrainPerMinute value.")
                                .define("WarChestDrainUsePercent", true);

                WAR_CHEST_DRAIN_PERCENT = BUILDER.comment(
                                "Percentage of war chest max capacity drained per minute during active war (0.0-1.0). "
                                                +
                                                "Only used when WarChestDrainUsePercent is true. "
                                                +
                                                "Example: 0.004 = 0.4% of max capacity per minute (100/min on a 25k chest, ~4h to deplete).")
                                .defineInRange("WarChestDrainPercent", 0.004, 0.0, 1.0);

                WAR_CHEST_MAX_CAPACITY = BUILDER.comment(
                                "Maximum capacity of the war chest. Lowered to prevent excessive stockpiling.")
                                .defineInRange("WarChestMaxCapacity", 25000, 1000, Integer.MAX_VALUE);
                ...
                WAR_CHEST_AUTO_DEPOSIT_PERCENT = BUILDER.comment(
                                ...
                                .defineInRange("WarChestAutoDepositPercent", 0.05, 0.0, 1.0);

                WAR_DEFENDER_DRAIN_REDUCTION = BUILDER.comment(
                                "Fraction by which the defending colony's war chest drain is reduced during war (0.0-1.0). "
                                                +
        ...
        public static double getWarChestMinPercentOfOwnTax() {
                return WAR_CHEST_MIN_PERCENT_OF_OWN_TAX.get();
        }
        ...
        public static boolean isWarChestDrainUsePercent() {
                return WAR_CHEST_DRAIN_USE_PERCENT.get();
        }

        public static double getWarChestDrainPercent() {
                return WAR_CHEST_DRAIN_PERCENT.get();
        }
