...
public abstract class BookPage {
     ...
     * Only TreasuryPage needs this.
     */
    public void init() {}

    /**
     * Called after all scissor regions are disabled. Pages override this to render
     * hover tooltips that must not be clipped by the page scissor regions.
     */
