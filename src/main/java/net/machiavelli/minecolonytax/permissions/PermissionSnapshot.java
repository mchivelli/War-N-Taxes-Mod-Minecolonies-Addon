...
public class PermissionSnapshot {
    ...
    private static boolean hasActiveConflict(int colonyId) {
        ...
        // Check active besieges. Besiege shares the Hostile-rank machinery, so without this an
        // ending war/raid on the same colony would restore (clear) the besiege's Hostile nodes and
        // consume its snapshot, silently neutering the live siege.
